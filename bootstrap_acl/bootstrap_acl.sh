...
ACL_DIRECTORY="/etc/hashicorp-acl"
NOMAD_BOOTSTRAP_TOKEN="$script_dir/nomad.bootstrap.token"
CONSUL_BOOTSTRAP_TOKEN="$script_dir/consul.bootstrap.token"
NOMAD_USER_TOKEN="$script_dir/nomad.user.token"
